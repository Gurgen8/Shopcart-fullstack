  ...
  return (
    <div className="product">
        ...
        <div className="productTopRight">
          ...
          <div className="productInfoBottom">
            ...
            <div className="productInfoItem">
              ...
              <span className="productInfoValue">{product?.sales || 0} % </span>
            </div>
            <div className="productInfoItem">
      ...
      <div className="productBottom">
        <form onSubmit={(e)=>e.preventDefault()} className="productForm">
          <div className="productFormLeft">
            <label>Product Name</label>
            <input name="title" onChange={handleChange} type="text" placeholder={product?.title} />
            <label>Product Description</label>
            <input name="desc" onChange={handleChange} type="text" id="price" placeholder={product?.desc} />
            <label >Price</label>
            <input name="price" onChange={handleChange} type="number"  placeholder={product?.price } />
            <label >sales %</label>
            <input name="sales" onChange={handleChange} type="number" placeholder={product?.sales +"%"} />
